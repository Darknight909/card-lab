const CACHE='card-lab-shell-v2-0';
const ASSETS=['./index.html','./styles.css?v=2.0','./app.js?v=2.0','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-180.png','./version.json'];
