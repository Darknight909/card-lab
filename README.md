# Card Lab v1.4 — GitHub Pages frontend
...
v1.4 changes: photos are Section 1, card details Section 2; analysis images are resized for transport; network/load failures retry automatically up to three times.
